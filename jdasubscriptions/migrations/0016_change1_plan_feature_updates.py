...
AKWABA_FEATURES = [
    ...
    {"name": "Recommendations",              "visible": True,
     "sub_items": ["Top 10 Buy", "Top 10 Sell", "Avis sur valeur"],
     "sub_items_excluded": ["Avis sur valeur"]},
    ...
    {"name": "Avis sur toutes les valeurs",  "visible": False},
]
...
AKWABA_GOLD_FEATURES = [
    ...
    {"name": "Avis sur toutes les valeurs",  "visible": True},
]
...
# Silver Access: remove Corporate Access only; update renames in-place.
SILVER_ACCESS_FEATURES = [
    {"name": "Access to all publications available on the platform", "visible": True},
    {"name": "Newsletters",                  "visible": True},
    {"name": "IPO Analysis",                 "visible": True},
    {"name": "Recommendations",              "visible": True,
     "sub_items": ["Avis sur valeur"]},
    {"name": "Research Notes",               "visible": True},
    {"name": "Economic Notes",               "visible": True},
    {"name": "Opinion on all stocks",        "visible": False},
    {"name": "Quarterly Results Commentary", "visible": True},
...
# ───────────────────────── PREVIOUS feature lists (from 0015, for reverse) ─────────────────────────
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("jdasubscriptions", "0015_update_plan_features_v2"),
    ]
